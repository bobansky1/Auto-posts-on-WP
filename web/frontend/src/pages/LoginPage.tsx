    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm animate-scale-in">
        ...
        <div className="glass rounded-2xl p-8">
          <h1 className="font-display text-2xl font-700 text-white mb-1 tracking-tight">Вход</h1>
          <p className="text-sm text-gray-400 mb-6">Введите данные вашего аккаунта</p>
